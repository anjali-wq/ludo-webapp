...
function Stuck() {
    ...
    if (onboard[currpawn] == 0 || currPos + num > 44) {
        if (DontHaveOtherFree() || currPos + num > 44) {
            ...
            dice.style.backgroundImage = "url(static/Images/dice.gif)";
...
function randomNum() {
    // if (validturn == turn && document.getElementById('player').innerText == 'red' || turn == validturn && document.getElementById('player').innerText == 'blue' || turn == validturn && document.getElementById('player').innerText == 'yellow' || turn == validturn && document.getElementById('player').innerText == 'green') {
    if (!clicked) {
        ...
        //     var dice = document.getElementById('dice');
        //     dice.style.backgroundImage = "url(/static/Images/" + num + ".jpg)";
        //     clicked = true;
        // }
...
function randomMove(Color, paw) {
    ...
    NumOfPaw = paw;
    currcolor = Color;
    currpawn = currcolor + "pawn" + NumOfPaw; //jo goti chl rhe h uske string bna de
    currPos = positions[currpawn]; // goti ks position py pari h
    //console.log(currPos);
    if (num + currPos > 44) {
        Stuck();
    } else {
